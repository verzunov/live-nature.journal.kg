<?php return array (
  ...
  'user.interests.description' => '(Разделяйте интересы запятой или нажимайте «Enter»)',
  ...
  'user.login.lostPassword.confirmationSent' => 'Подтверждение было отправлено на ваш адрес электронной почты. Пожалуйста, следуйте инструкциям в письме, чтобы сбросить пароль.',
  ...
  'user.logOutAs' => 'Выйти из системы как',
  ...
  'user.preferredPublicName.description' => 'Как вы хотите, чтобы к вам обращались? При желании вы можете добавить сюда приветствие, отчество/второе имя и суффиксы.',
  ...
  'user.apiKey.generate' => 'Сгенерировать новый ключ API',
