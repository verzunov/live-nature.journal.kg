<?php return array (
  'plugins.importexport.pubmed.displayName' => 'Модуль «Экспорт в PubMed XML»',
  'plugins.importexport.pubmed.description' => 'Экспортирует метаданные статей в формат PubMed XML для индексирования в MEDLINE.',
