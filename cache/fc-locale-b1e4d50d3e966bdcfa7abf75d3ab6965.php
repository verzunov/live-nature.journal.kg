<?php return array (
  ...
  'submission.submit.cancelSubmission' => 'Вы можете закончить эту отправку позже, выбрав «Активные материалы» на домашней странице автора.',
  ...
  'author.submit.copyrightNoticeAgree' => 'Авторы согласны с Условиями передачи авторских прав, которые будут применены к этому материалу в случае, если он будет опубликован этим журналом (комментарии для редактора могут быть добавлены ниже).',
  ...
  'author.submit.form.sectionRequired' => 'Пожалуйста, выберите подходящий раздел журнала для этого материала.',
  'author.submit.form.localeRequired' => 'Пожалуйста, выберите язык отправляемого материала.',
  'submission.submit.privacyStatement' => 'Заявление журнала о конфиденциальности',
  ...
  'author.submit.confirmationDescription' => 'Нажмите «Завершить отправку», чтобы отправить ваш материал в журнал «{$journalTitle}». Основной автор, указанный для переписки с редакцией, получит подтверждение по электронной почте и будет иметь возможность следить за прохождением материала через редакционный процесс, заходя на веб-сайт журнала. Спасибо за интерес к публикации в журнале «{$journalTitle}».',
  'author.submit.noFiles' => 'Ни один файл не был прикреплен к этому отправляемому материалу.',
