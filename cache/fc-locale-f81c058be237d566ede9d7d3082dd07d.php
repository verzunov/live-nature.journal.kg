<?php return array (
  ...
  'manager.setup.searchEngineIndexing.sitemapDescription' => 'A XML sitemap is available for submitting to search engines at <a href="{$path}" target="_blank">{$path}</a>',
  ...
  'manager.navigationMenus' => 'Navigation Menus',
  ...
  'stats.articlesOfTotal' => '{$count} of {$total} articles',
  'stats.daily' => 'Daily',
  ...
  'stats.dateRange.instruction' => 'Enter each date in the format YYYY-MM-DD. For example, if you want the date for 15 January, 2019, enter 2019-01-15.',
