...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d241c35260000_73552535',
...
function content_5d241c35260000_73552535 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin13->smartyFBVFormSection(array('title'=>"submission.metadata"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin13->smartyFBVFormSection(array('title'=>"submission.metadata"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin14->smartyFBVFormArea(array('id'=>"additionalDublinCore"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin15->smartyFBVFormSection(array('title'=>"submission.coverage",'for'=>"coverage",'required'=>$_smarty_tpl->tpl_vars['coverageRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin15->smartyFBVFormSection(array('title'=>"submission.coverage",'for'=>"coverage",'required'=>$_smarty_tpl->tpl_vars['coverageRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin16->smartyFBVFormSection(array('for'=>"type",'title'=>"common.type",'required'=>$_smarty_tpl->tpl_vars['typeRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin16->smartyFBVFormSection(array('for'=>"type",'title'=>"common.type",'required'=>$_smarty_tpl->tpl_vars['typeRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin17->smartyFBVFormSection(array('label'=>"submission.source",'for'=>"source",'required'=>$_smarty_tpl->tpl_vars['sourceRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin17->smartyFBVFormSection(array('label'=>"submission.source",'for'=>"source",'required'=>$_smarty_tpl->tpl_vars['sourceRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin18->smartyFBVFormSection(array('label'=>"submission.rights",'for'=>"rights",'required'=>$_smarty_tpl->tpl_vars['rightsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin18->smartyFBVFormSection(array('label'=>"submission.rights",'for'=>"rights",'required'=>$_smarty_tpl->tpl_vars['rightsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin14->smartyFBVFormArea(array('id'=>"additionalDublinCore"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}?>
...
$_block_repeat=true;
echo $_block_plugin19->smartyFBVFormArea(array('id'=>"tagitFields",'title'=>"submission.submit.metadataForm"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin20->smartyFBVFormSection(array('label'=>"common.subjects",'required'=>$_smarty_tpl->tpl_vars['subjectsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin20->smartyFBVFormSection(array('label'=>"common.subjects",'required'=>$_smarty_tpl->tpl_vars['subjectsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin21->smartyFBVFormSection(array('label'=>"search.discipline",'required'=>$_smarty_tpl->tpl_vars['disciplinesRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin21->smartyFBVFormSection(array('label'=>"search.discipline",'required'=>$_smarty_tpl->tpl_vars['disciplinesRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin22->smartyFBVFormSection(array('label'=>"common.keywords",'required'=>$_smarty_tpl->tpl_vars['keywordsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin22->smartyFBVFormSection(array('label'=>"common.keywords",'required'=>$_smarty_tpl->tpl_vars['keywordsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin23->smartyFBVFormSection(array('label'=>"submission.supportingAgencies",'required'=>$_smarty_tpl->tpl_vars['agenciesRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin23->smartyFBVFormSection(array('label'=>"submission.supportingAgencies",'required'=>$_smarty_tpl->tpl_vars['agenciesRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin24->smartyFBVFormSection(array('label'=>"submission.citations",'required'=>$_smarty_tpl->tpl_vars['citationsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin24->smartyFBVFormSection(array('label'=>"submission.citations",'required'=>$_smarty_tpl->tpl_vars['citationsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin19->smartyFBVFormArea(array('id'=>"tagitFields",'title'=>"submission.submit.metadataForm"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}?>
