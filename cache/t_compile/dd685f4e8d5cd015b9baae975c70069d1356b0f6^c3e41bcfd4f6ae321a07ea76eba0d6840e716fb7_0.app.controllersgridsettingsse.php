<?php
/* Smarty version 3.1.33, created on 2019-07-08 08:20:06
  from 'app:controllersgridsettingsse' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d22fcb6dca4f3_82838144',
...
function content_5d22fcb6dca4f3_82838144 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
?>
	...
	<?php if ($_smarty_tpl->tpl_vars['sectionEditorCount']->value == 0) {?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormArea', array('id'=>"indexingInfo",'title'=>"submission.indexing"));
$_block_repeat=true;
echo $_block_plugin7->smartyFBVFormArea(array('id'=>"indexingInfo",'title'=>"submission.indexing"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php $_block_repeat=false;
echo $_block_plugin7->smartyFBVFormArea(array('id'=>"indexingInfo",'title'=>"submission.indexing"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
', 'SelectListPanel', <?php echo $_smarty_tpl->tpl_vars['subEditorsListData']->value;?>
);
				<?php echo '</script'; ?>
>
			</div>
