...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d24186c697a21_50539558',
...
function content_5d24186c697a21_50539558 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
ob_start();?>
	...
	<?php $_smarty_tpl->_subTemplateRender("core:submission/submissionLocale.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

	<?php echo $_smarty_tpl->tpl_vars['additionalFormContent2']->value;?>


		<?php if ($_smarty_tpl->tpl_vars['currentContext']->value->getLocalizedSetting('submissionChecklist')) {?>
...
ob_start();?>
			<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['currentContext']->value->getLocalizedSetting('submissionChecklist'), 'checklistItem', false, 'checklistId', 'checklist', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['checklistId']->value => $_smarty_tpl->tpl_vars['checklistItem']->value) {
?>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"checkbox",'id'=>"checklist-".((string)$_smarty_tpl->tpl_vars['checklistId']->value),'required'=>true,'value'=>1,'label'=>$_smarty_tpl->tpl_vars['checklistItem']->value['content'],'translate'=>false,'checked'=>false),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<?php if ($_smarty_tpl->tpl_vars['copyrightNoticeAgree']->value) {?>
