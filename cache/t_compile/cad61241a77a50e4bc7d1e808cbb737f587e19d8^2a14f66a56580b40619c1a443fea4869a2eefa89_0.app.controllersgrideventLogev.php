...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d241eadeeff74_56596162',
...
function content_5d241eadeeff74_56596162 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
<?php echo '</script'; ?>
>
<form class="pkp_form" id="eventLogFilterForm" action="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_COMPONENT'),'op'=>"fetchGrid"),$_smarty_tpl ) );?>
" method="post">
