...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d22df40f367b3_58353897',
  ...
  'includes' => 
  array (
    'core:linkAction/buttonConfirmationLinkAction.tpl' => 1,
    'app:linkAction/buttonGenericLinkAction.tpl' => 1,
    'app:linkAction/buttonRedirectLinkAction.tpl' => 1,
  ),
),false)) {
function content_5d22df40f367b3_58353897 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin13->smartyFBVFormSection(array('class'=>"formButtons form_buttons"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_smarty_tpl->_subTemplateRender("core:linkAction/buttonConfirmationLinkAction.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('buttonSelector'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "#",$_smarty_tpl->tpl_vars['submitButtonId']->value )),'dialogText'=>((string)$_smarty_tpl->tpl_vars['FBV_confirmSubmit']->value)), 0, false);
?>
	<?php }?>

	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"submit",'class'=>"submitFormButton",'id'=>$_smarty_tpl->tpl_vars['submitButtonId']->value,'label'=>$_smarty_tpl->tpl_vars['FBV_submitText']->value,'translate'=>$_smarty_tpl->tpl_vars['FBV_translate']->value,'disabled'=>$_smarty_tpl->tpl_vars['FBV_submitDisabled']->value),$_smarty_tpl ) );?>
...
" class="cancelButton"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>$_smarty_tpl->tpl_vars['FBV_cancelText']->value),$_smarty_tpl ) );?>
	...
	<?php }
$_block_repeat=false;
echo $_block_plugin13->smartyFBVFormSection(array('class'=>"formButtons form_buttons"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
