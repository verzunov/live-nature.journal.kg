<?php return array (
  ...
  'submission.submit.contactConsent' => 'Контакт для переписки',
  'submission.submit.contactConsentDescription' => 'Да, я согласен, чтобы вы связывались со мной по поводу этого материала.',
  'submission.submit.userGroupDescriptionManagers' => 'Отправьте под одной из следующих ролей, если вы хотите иметь возможность редактировать и публиковать этот материал самостоятельно: {$managerGroups}',
  ...
  'submission.submit.copyrightNoticeAgree' => 'Да, я согласен выполнять Условия передачи авторских прав.',
  ...
  'submission.citations.description' => 'Введите каждую ссылку на новой строке, чтобы их можно было потом извлечь.',
  ...
  'submission.event.participantAdded' => '{$name} ({$username}) был назначен в этот материал как {$userGroupName}.',
  'submission.event.participantRemoved' => '«{$name}» ({$username}) удален как {$userGroupName}.',
  ...
  'submission.event.fileRevised' => 'Версия «{$name}» (ID файла {$fileId}-{$fileRevision}) была загружена.',
  ...
  'submission.submit.submissionLocaleDescription' => 'Принимаются материалы на нескольких языках. Выберите основной язык отправляемого материала из выпадающего меню выше.',
  ...
  'submission.submit.form.agenciesRequired' => 'Пожалуйста, укажите спонсоров.',
  ...
  'editor.submission.roundStatus.revisionsSubmitted' => 'Новые версии были отправлены.',
  ...
  'editor.submission.roundStatus.reviewsCompleted' => 'Все рецензии пришли, нужно принять решение.',
  ...
  'editor.submission.addStageParticipant.form.reviewerWarning' => 'Выбранный вами пользователь назначен проводить «слепое» рецензирование. Если вы назначите его участником, он получит доступ к информации об авторе. Рекомендуем вам не назначать этого участника, если вы не уверены в том, что удастся сохранить независимость процесса «слепого» рецензирования.',
  ...
  'editor.submission.decision.noDecisionsAvailable' => 'Назначить редактора, чтобы включить решения редакции для этого этапа.',
  ...
  'editor.submission.decision.nextButton' => 'Далее: Выбрать файлы для {$stageName}',
  'editor.submission.decision.selectFiles' => 'Выберите файлы: которые вы хотите отправить на этап «{$stageName}».',
  'editor.submission.decision.previousAuthorNotification' => 'Назад: Уведомление автора',
  ...
  'submission.list.count' => '{$count} материалов',
  'submission.list.itemsOfTotal' => '{$count} из {$total} материалов',
  'submission.list.responseDue' => 'Срок ответа на запрос',
  'submission.list.reviewDue' => 'Срок сдачи рецензии',
  'submission.list.reviewComplete' => 'Рецензия отправлена',
  'submission.list.confirmDelete' => 'Удалить материал?',
  'submission.list.itemOrdererUp' => 'Поднять вверх «{$itemTitle}»',
  'submission.list.itemOrdererDown' => 'Опустить вниз «{$itemTitle}»',
