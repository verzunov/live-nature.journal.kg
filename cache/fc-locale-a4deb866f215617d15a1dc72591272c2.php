<?php return array (
  ...
  'plugins.generic.orcidProfile.manager.settings.sendMailToAuthorsOnPublication' => 'Send e-mail to request ORCID authorization from article authors on publication of a new issue',
