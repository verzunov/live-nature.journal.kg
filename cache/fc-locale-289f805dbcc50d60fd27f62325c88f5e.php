<?php return array (
  ...
  'submission.submit.contactConsentDescription' => 'I agree to be contacted about this submission.',
  ...
  'submission.citations.description' => 'Enter each reference on a new line so that it can be extracted.',
  ...
  'submission.event.fileRevised' => 'Revision "{$name}" (file ID {$fileId}-{$fileRevision}) was uploaded.',
  ...
  'submission.submit.form.agenciesRequired' => 'Please enter a supporting agency.',
  ...
  'editor.submission.addStageParticipant.form.reviewerWarning' => 'The participant you selected has been assigned to conduct a blind review. If you assign them as a participant, they will have access to the author\'s identity. You are encouraged not to assign this participant unless you can independently ensure the integrity of the peer review process.',
  ...
  'submission.list.count' => '{$count} submissions',
  'submission.list.itemsOfTotal' => '{$count} of {$total} submissions',
  'submission.list.responseDue' => 'Response Due',
  'submission.list.reviewDue' => 'Review Due',
  'submission.list.reviewComplete' => 'Review Submitted',
  'submission.list.confirmDelete' => 'Delete submission?',
  'submission.list.itemOrdererUp' => 'Increase position of {$itemTitle}',
  'submission.list.itemOrdererDown' => 'Decrease position of {$itemTitle}',
